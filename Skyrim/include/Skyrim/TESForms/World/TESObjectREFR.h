...
public:
	...
	virtual Explosion*  AsExplosion(void);								// 005EADD0 { return nullptr; }	ChainExplosion, Explosion={ return this; }
	virtual Projectile* AsProjectile(void);								// 005EADD0 { return nullptr; } Projectile, AllowProjectile, MissileProjectile={ return this; }
	...
	bool IsDeleted() const {
		return (flags & kFlagIsDeleted) != 0;
	}

	// Is this object currently disabled?
	bool IsDisabled() const {
		return (flags & kFlagIsDisabled) != 0;
	}
	...
	bool IsIgnoringFriendlyHits() const {
		return (flags & kFlagIgnoreFriendlyHits) != 0;
	}
