...
#include "Skyrim/RTTI.h"  // RTTI_bhkCharacterController

#include "Skyrim/BSCore/BSTEvent.h"  // BSTEventSource
#include "Skyrim/NetImmerse/NiRefObject.h"  // NiRefObject
...
class alignas(0x08) bhkCharacterController :
	public NiRefObject,									// 000
	public BSTEventSource<bhkCharacterMoveFinishEvent>	// 008
{
public:
	...
	DEFINE_MEMBER_FN(FreezeActor, void, 0x006A6B50, float unk01);
